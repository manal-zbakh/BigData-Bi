...
while(turn_it):
    ...
    for journal in journals:
        ...
        dico_journal = {"Title": title_tmp, "Abstract": abstract_tmp, "Type": type_tmp,
                        "Date": date_tmp, "Year": year_tmp, "Month": num_month_tmp, "MonthName": month_name_tmp, "Day": day_tmp, "DOI": journal_link_tmp, "Publisher": pub_tmp, "Authors": authors_tmp, "Locations": all_locations_tmp, "Countries": all_countries_tmp}
